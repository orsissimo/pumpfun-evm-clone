 ...
 * @see https://v0.dev/t/VNASegF33do
            ...
            <div className="mt-1 flex justify-center rounded-md border-2 border-dashed border-muted px-6 pt-5 pb-6">
              <div className="space-y-1 text-center">
                <div className="flex items-center justify-center">
                  ...
                  <span className="relative cursor-pointer rounded-md bg-muted px-2 py-1 font-medium text-muted-foreground focus-within:outline-none focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2 hover:bg-muted-foreground hover:text-background">
