          ...
          <div className="flex flex-col items-start justify-center bg-background text-foreground">
            <div className="max-w-3xl space-y-6 text-left">
              ...
              <p className="text-muted-foreground text-lg md:text-xl">
                Pump.style is a cutting-edge launchpad that empowers users to
                create tokens effortlessly within seconds, without any technical
                expertise or the need to provide liquidity.
              </p>
              <p className="text-muted-foreground text-lg md:text-xl">
                Tokens are generated free of charge (aside from gas fees) and
                are instantly tradable on the platform, offering a seamless
                experience for anyone looking to launch their own digital asset.
              </p>
            </div>
          </div>
        );
          ...
          <div className="flex flex-col items-start justify-center bg-background text-foreground">
            <div className="max-w-3xl space-y-6 text-left">
              ...
              <p className="text-muted-foreground text-lg md:text-xl">
                ...
                curve, where liquidity is generated by investor participation
                through token buys and sells.
              </p>
              <p className="text-muted-foreground text-lg md:text-xl">
                At launch, the initial virtual liquidity is 1ETH and tokens
                typically have an initial market cap between $2,500 and $3,000,
                depending on the current price of ETH.
              </p>
              <p className="text-muted-foreground text-lg md:text-xl">
                Once the token's market cap reaches approximately $50,000 (with
                slight variations based on ETH price fluctuations), it is
                automatically listed on Uniswap with 4ETH in liquidity. In the
                same transaction, the liquidity pool (LP) is burned, and the
                Smart Contract is renounced, ensuring transparency and
                decentralization. Following this, the token becomes visible to
                trading bots for users who employ them.
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div className="flex flex-col items-start justify-center bg-background text-foreground">
            <div className="max-w-3xl space-y-6 text-left">
              ...
              <p className="text-muted-foreground text-lg md:text-xl">
                Creating your own tokens on pump.style is a quick and simple
                process:
              </p>
              <ol className="space-y-4 text-lg md:text-xl list-decimal pl-5">
                <li>
                  Connect your wallet to the platform and ensure you have ETH on
                  the ETH Mainnet.
                </li>
                <li>
                  Navigate to the "Token Deployer" section and fill in the
                  necessary details for your token. Supported image formats
                  include jpg, gif (512KB max), png and jpeg. If your logo
                  upload fails, contact support to manually add it.
                </li>
                <li>
                  Click "Deploy" to launch your token. As the creator, you have
                  the option to purchase your own tokens first, though it's not
                  required.
                </li>
                <li>
                  Confirm the transaction in your wallet, and your token is
                  live!
                </li>
              </ol>
              <Image
          ...
          <div className="flex flex-col items-start justify-center bg-background text-foreground">
            <div className="max-w-3xl space-y-6 text-left">
              ...
              <ol className="space-y-4 text-lg md:text-xl list-decimal pl-5">
                ...
                <li>
                  Open the token’s page, where you'll find the swap window on
                  the right.
                </li>
                <li>
                  Enter the amount of ETH or tokens you wish to buy or sell, and
                  the system will display the equivalent amount in tokens.
                </li>
          ...
          <div className="flex flex-col items-start justify-center bg-background text-foreground">
            <div className="max-w-3xl space-y-6 text-left">
              ...
              <div className="space-y-4 text-lg md:text-xl">
                When $PUMP official token will be live, half of all service fees
                will be used to buyback and burn it!
              </div>
            </div>
          </div>
        );
        ...
        return (
          <div className="flex flex-col items-start justify-center bg-background text-foreground">
            <div className="max-w-3xl space-y-6 text-left">
              ...
              <p className="text-muted-foreground text-lg md:text-xl">
                If you need any help or encounter any issues while using
                Pump.style, we're here to assist you. Here’s how you can get
                support:
              </p>
              <ul className="space-y-4 text-lg md:text-xl">
                <li>
